...
public:
    ...
    void retranslateUi(QDialog *ReleaseNotesDialog)
    {
        ...
        m_releaseNotesLabel->setText(QApplication::translate("ReleaseNotesDialog", "<html><head/><body><p><span style=\" font-family:'Open Sans'; font-size:16px;\">Release Notes</span></p><br><p><span style=\" font-family:'Consolas'; font-size:14px;\">v2.0.1 - (16-Dec-2018)<br>- Added more checkpoints to sync with the correct chain</span></p><p><span style=\" font-family:'Consolas'; font-size:14px;\">v2.0.0 - (10-Dec-2018)<br>- Added MTP fix for LWMA difficulty algo at height 315000<br>- Added wallet burn bug fix</span></p><p><span style=\" font-family:'Consolas'; font-size:14px;\">v1.0.4 - (26-Nov-2018)<br>- Added more checkpoints to sync with the correct chain</span></p><p><span style=\" font-family:'Consolas'; font-size:14px;\">v1.0.3 - (16-Oct-2018)<br>- Fixed 0 balance and 0 transactions after a wallet reset</span></p><p><span style=\" font-family:'Consolas'; font-size:14px;\">v1.0.2 - (09-Oct-2018)<br>- MIXIN is now working to set<br>- Standard TX fee changed from 0.001 to 0.000001 B2B<br>- Max amount to send changed from 5000 to 100000 B2B</span></p><p><span style=\" font-family:'Consolas'; font-size:14px;\">v1.0.1 - (04-Oct-2018)<br>- Added Release Notes in help section of the wallet</span></p><p><span style=\" font-family:'Consolas'; font-size:14px;\">v1.0.0 - (04-Oct-2018)<br>- First release of B2Bcoin QT GUI wallet</span></p></body></html>", 0));
